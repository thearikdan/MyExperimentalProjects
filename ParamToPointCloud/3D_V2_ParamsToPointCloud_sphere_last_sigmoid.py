...
#DATA_DIR = '/media/ara/HDD/MyProjects/primitives_to_point_clouds/data/box/1500_1024'
BATCH_SIZE = 32
...
PROJECT_NAME = "PPC2_V2_3D_SPHERE_1500_1024_drop_04_PSG_LOSS_TFLEARN_REG_LAST_SIGMOID"
...
with tf.device('/gpu:1'):
	...
	#    dim_layer = tf.layers.dense(inputs=dropout1, units=POINT_COUNT * DIMS, activation=tf.nn.relu, name = out_name)
	    dim_layer_1 = tflearn.layers.core.fully_connected(dropout1, POINT_COUNT * DIMS, activation=tf.nn.relu, weight_decay=1e-4,
		                                     regularizer='L2', name=out_name)
            dim_layer = tf.contrib.layers.batch_norm(dim_layer_1, 
