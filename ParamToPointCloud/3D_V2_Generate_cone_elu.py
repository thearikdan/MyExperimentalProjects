...
PROJECT_NAME = "PPC2_V2_3D_CONE_1500_1024_ELU"

DATA_DIR = '/raid/Github/experiments/mintools/point_cloud/primitives_to_point_clouds/data/cone/1500_1024'
...
with tf.Session(config=tf.ConfigProto(
 ...
 #   fname = get_latest_file(MODEL_PATH, EXCLUDE_SUFFIX)
    fname = "saved_sessions/PPC2_V2_3D_CONE_1500_1024_ELU/PPC2_V2_3D_CONE_1500_1024_ELU_6000.ckpt"
    ...
    cones = ["cone_40_60_", "cone_40_30_"] #array of cones to generate
    count = len(cones)

    file_names = []
    data_files = []
    for i in range (count):
        file_names.append(cones[i] + ".ply")
        data_files.append(GENERATED_DEBUG_DIR + '/' + cones[i] + ".csv")
    ...
    write_multiple_point_clouds_to_file(GENERATED_DIR, "compare_cones.ply", out_clouds)
