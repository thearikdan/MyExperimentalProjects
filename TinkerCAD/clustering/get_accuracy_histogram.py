...
def get_count_data(my_list):
    elements = set(my_list)
    dict = {}
    for e in elements:
        dict[e] = my_list.count(e)
    return dict
...
clean_dict = get_count_data(clean_labels)
print clean_dict
...
kmean_dict_list = []
for h in histogramme:
    dict = get_count_data(h)
    kmean_dict_list.append(dict)

print kmean_dict_list
