...
def show(count, start_date, end_date, title, subtitles, x_list, y_list):
...
def show_with_reference(count, start_date, end_date, title, subtitles, x_list, y_list, reference):
