...
is_data_available, date_time, volume , opn, close, high, low = read.get_intraday_data("AMZN", start_date, end_date, 5)
...
is_data_available, date_time, volume , opn, close, high, low = read.get_intraday_data("AMZN", start_date, end_date, 20)
