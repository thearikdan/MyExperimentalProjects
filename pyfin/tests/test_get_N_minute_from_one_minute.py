...
t1, v1, o1, c1, h1, l1 = time_op.get_N_units_from_one_unit_interval(1, time_list, volume_list , opn_list, close_list, high_list, low_list)
...
t3, v3, o3, c3, h3, l3 = time_op.get_N_units_from_one_unit_interval(3, time_list, volume_list , opn_list, close_list, high_list, low_list)
