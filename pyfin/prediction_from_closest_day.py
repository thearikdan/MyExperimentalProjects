...
def get_linear_interpolation_prediction(symbol, from_date_time, to_date_time, days_count_to_analyse, top_days_count_to_interpolate):
    ...
    start, end, dist = prediction.get_closest_distances_time_to_predict_and_distances(symbol, from_date_time, to_date_time, days_count_to_analyse)
...
predicted_prices, times, closest_date_times, distances = get_linear_interpolation_prediction(symbol, start_date, end_date, days_count, interp_count)
